...
|Avoid unnecessary terms in the action label if the view name or record header is in immediate context. Example: for a record’s global action, use “Update” instead of “Update \<Record Name>lt;Record Name\<Record Name>gt;”.|Related Actions|
